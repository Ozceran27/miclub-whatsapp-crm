-- Corrige definitivamente el origen de "Cuotas a cobrar".
-- Mantiene el estado operativo efectivo (v_enrollment_operational_status) y normaliza
-- cuotas históricas con un cero extra antes de aplicar la comisión del club.
-- Caso real: fee_amount 8.110.000 en Fitness => 811.000 * 50% = 405.500.
