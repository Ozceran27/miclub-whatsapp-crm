-- Alinea las cuotas a cobrar con el mismo estado operativo efectivo usado por Inicio/deudores.
-- v_enrollment_operational_status recalcula diariamente Al día/Adeudando/Abandonado según pagos y vencimiento.
