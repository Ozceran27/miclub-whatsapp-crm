-- Correct opening-balance movements to use the canonical paid financial status.
-- `pagado` is already part of miclub.financial_status; do not expand the enum for aliases.
BEGIN;
