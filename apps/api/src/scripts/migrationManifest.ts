...
export const migrationManifest: readonly MigrationManifestEntry[] = [
  ...
  { path: "202608310002_sector_capacity_modes.sql", sha256: "36df6e7923df8087cdaed56fe3dd680402a41af5be0baea282c393bbcfd120bd", dependsOn: ["202608210004_sector_templates_and_lifecycle.sql", "202608310001_exchange_rates.sql"], requires: ["miclub.table.exchange_rates"], provides: ["miclub.view.v_sector_monthly_completed_income", "miclub.view.v_sector_capacity_metrics"], checkpointPurpose: "Normaliza modos de capacidad y centraliza récord, utilización y ociosidad por sector y tenant." },
];
