...
export const migrationManifest: readonly MigrationManifestEntry[] = [
  ...
  { path: "202608150004_runtime_roles_and_priority_rls.sql", sha256: "cab7c0342994bd3d766bd87f49d0c48a117b23d1a377f48b186017f88ecbb9c3", dependsOn: ["202608140001_version_xlsx_import_rows.sql", "202608150003_fix_activity_status_enum_guard.sql"], provides: ["postgres.role.miclub_runtime", "postgres.role.miclub_admin"], checkpointPurpose: "Separa los roles runtime y administrativo, y fuerza RLS en el primer conjunto de tablas tenant críticas." },
];
