...
export const migrationManifest: readonly MigrationManifestEntry[] = [
  ...
  { path: "202608180003_fix_rls_login_membership_resolution.sql", sha256: "2d05b5f421cdceb22f6bfd161643cc705c6035bc111277d59be0d002100e0913", dependsOn: ["202608180002_restore_runtime_application_grants.sql", "202608160001_commercial_plan_taxonomy.sql"], provides: ["miclub.function.resolve_login_membership"], checkpointPurpose: "Permite resolver el contexto tenant mínimo después de validar la contraseña pese a FORCE RLS y completa con FREE los clubes sin suscripción activa." },
  ...
  { path: "202608210001_operational_currency_opening_balances.sql", sha256: "309708c724168193a872ef6ba1b7b798f92835b6c9f3d2f6942e32e331566ea9", dependsOn: ["202608140008_canonical_onboarding_and_opening_balances.sql"], provides: ["miclub.opening_balance_batches.operational_currency_code"], checkpointPurpose: "Persiste la moneda operativa elegida y la aplica a los saldos iniciales idempotentes." },
  { path: "202608210002_canonical_activity_financial_views.sql", sha256: "6c28a57110b032111f610d5922a2425727234100afd00a4db773ddab6a3caeac", dependsOn: ["202608150005_prevent_split_settlement_movements.sql"], provides: ["miclub.view.v_activity_settlement_balances", "miclub.view.v_activity_settlement_sector_balances"], checkpointPurpose: "Reemplaza saldos inferidos por etiquetas con liquidaciones canónicas por actividad, término histórico, período y asignaciones explícitas." },
  { path: "202608210003_complete_product_category_catalog.sql", sha256: "625d17b1d410fc475ac38efa5e97188002245fce402fd9340dfa76ba03903120", dependsOn: ["202608140004_correct_category_catalog.sql"], requires: ["miclub.table.category_catalog", "miclub.table.category_import_aliases"], checkpointPurpose: "Sincroniza exactamente el catálogo activo de producto, sus aliases y las categorías disponibles de cada tenant sin borrar historia." },
  { path: "202608210004_sector_templates_and_lifecycle.sql", sha256: "f55f8cd3c21adb53b7d9b33d7c92a5aee04a199603c1926e8b7003f5c9df5758", dependsOn: ["202608180002_restore_runtime_application_grants.sql", "202608150002_scope_activity_catalog_fks.sql"], requires: ["postgres.role.miclub_runtime", "postgres.role.miclub_admin"], provides: ["miclub.table.sector_templates", "miclub.sectors.template_id"], checkpointPurpose: "Versiona las 30 plantillas de sector con iconos, relaciones validadas y acceso runtime de solo lectura." },
  ...
  { path: "202608280001_separate_legacy_activity_enrollment_fee.sql", sha256: "2046914a6f164eecc79f0ecd81ab79a9ed48d15de172832896ee81fd0c768f64", dependsOn: ["202608270004_atomic_onboarding_completion.sql"], checkpointPurpose: "Hace nullable la cuota histórica de inscripción, documenta su semántica legado y la separa de la liquidación canónica sin borrar valores." },
  { path: "202608280002_sync_activity_visual_catalog.sql", sha256: "3a1a53ea858c41c722b6ec21fc70ccd7351157145164e33ca9cf26641a112bd4", dependsOn: ["202608130001_version_activity_terms.sql"], provides: ["miclub.table.activity_icon_aliases"], checkpointPurpose: "Sincroniza iconos de actividad con el contrato compartido, canoniza fútbol y conserva aliases para datos históricos." },
  { path: "202608280003_compensation_and_activity_term_currencies.sql", sha256: "eec48dafea3a924b9a2f2ef70e59814a09eb83020783994fac43d00b7c875e00", dependsOn: ["202608210001_operational_currency_opening_balances.sql", "202608270002_employee_compensation_and_photos.sql", "202608270003_activity_fee_frequencies.sql"], provides: ["miclub.employees.currency_code", "miclub.activity_terms.currency_code"], checkpointPurpose: "Explicita y valida la moneda de remuneraciones fijas y términos FIXED sin alterar versiones históricas." },
  { path: "202608310001_exchange_rates.sql", sha256: "a5e28d12ea69810112bc480d07a7026a8ed323693452cee6559387efe38ba9f4", dependsOn: ["202608140008_canonical_onboarding_and_opening_balances.sql"], requires: ["miclub.table.currencies"], provides: ["miclub.table.exchange_rates", "miclub.table.exchange_rate_sync_state", "miclub.table.exchange_rate_usages"], checkpointPurpose: "Persiste cotizaciones oficiales inmutables, estado de sincronización y referencias de valoración histórica." },
  { path: "202608310002_sector_capacity_modes.sql", sha256: "cfd830f3a2bc27f2010d237488de4ca24334792e812cb8cc7aa7243fa346827d", dependsOn: ["202608210003_complete_product_category_catalog.sql", "202608210004_sector_templates_and_lifecycle.sql", "202608310001_exchange_rates.sql"], requires: ["miclub.table.category_catalog", "miclub.table.exchange_rates"], provides: ["miclub.view.v_sector_monthly_completed_income", "miclub.view.v_sector_capacity_metrics"], checkpointPurpose: "Normaliza modos de capacidad y centraliza récord, utilización y ociosidad por sector y tenant." },
  { path: "202609010001_expand_activity_visual_catalog.sql", sha256: "bc9ec90ae651e645c8ca2628d35d36675c463042ae78e000be46cff5cc0dd898", dependsOn: ["202608280002_sync_activity_visual_catalog.sql"], requires: ["miclub.table.activity_icon_aliases"], checkpointPurpose: "Amplía idempotentemente el catálogo activo sin borrar claves históricas referenciadas." },
  { path: "202609010002_canonical_liquidity_valuation.sql", sha256: "1828bb71377045bc480a88223253d0de443d4662b00117333a7d93616979440b", dependsOn: ["202608310001_exchange_rates.sql"], requires: ["miclub.table.exchange_rates", "miclub.table.exchange_rate_usages"], provides: ["miclub.function.value_club_liquidity", "miclub.function.record_exchange_rate_usage"], checkpointPurpose: "Centraliza valoración multimoneda, caducidad, faltantes y trazabilidad reproducible de cotizaciones." },
  { path: "202609010003_exchange_rate_usage_components.sql", sha256: "a1926ed98d679de4a6ce08587bfc34beaa8bb95a0169d2c27a2e944435d16dde", dependsOn: ["202609010002_canonical_liquidity_valuation.sql"], requires: ["miclub.table.exchange_rates", "miclub.table.exchange_rate_usages"], provides: ["miclub.table.exchange_rate_usage_components"], checkpointPurpose: "Persiste en orden todos los identificadores inmutables que componen una cotización cruzada." },
  { path: "202609010004_explicit_billing_modes.sql", sha256: "de380c5496d867d2852282188aed2293f323347a11b6663b5a6733016eae15ae", dependsOn: ["202608160001_commercial_plan_taxonomy.sql"], requires: ["miclub.table.club_subscriptions"], provides: ["miclub.table.billing_payment_confirmations"], checkpointPurpose: "Persiste modo y origen de billing, y prepara confirmaciones de pasarela autenticadas e idempotentes sin conceder entitlements pendientes." },
  { path: "202609010005_commercial_plan_display_metadata.sql", sha256: "c795246ed991ac92e3f3c530de1e50e28709343c0e1bddb7ca1d210b738dde87", dependsOn: ["202608160001_commercial_plan_taxonomy.sql"], requires: ["miclub.table.plans"], provides: ["miclub.plans.display_metadata"], checkpointPurpose: "Centraliza en la base canónica la descripción, público, prestaciones, orden, recomendación, CTA y etiqueta de precio no definitivo de cada plan comercial." },
  ...
  { path: "202609190001_administration_configuration.sql", sha256: "c1002a3a9451f008bf59bd0245db3c9991f86ed878ea383ae77af10d6e18035e", dependsOn: ["202609090003_initial_obligation_applications.sql"], provides: ["miclub.table.employee_compensation_terms", "miclub.table.employee_compensation_obligations", "miclub.table.activity_settlement_adjustments", "miclub.table.payout_groups"], checkpointPurpose: "Habilita configuración permanente, remuneraciones versionadas, ajustes auditados y anulación de grupos desde Administración." },
  { path: "202609200001_required_system_sectors.sql", sha256: "432c12148fdcd6a65f7d96614507a09f73f81e776e96b9eef45a083b19e91ac0", dependsOn: ["202609190001_administration_configuration.sql"], checkpointPurpose: "Normaliza y garantiza Administración, Tesorería y Áreas Comunes como los tres sectores de sistema activos de cada club." },
  { path: "202609210001_worker_activity_responsibility.sql", sha256: "57e10ac34afff6fe9bd410a02f14948f07cafe251924a30f6612ae57eb099dd7", dependsOn: ["202609200001_required_system_sectors.sql"], provides: ["miclub.activities.responsible_employee_id"], checkpointPurpose: "Normaliza roles laborales, protege sectores de empleados por tenant y permite que cualquier trabajador activo sea responsable operativo de actividades." },
  { path: "202609210002_canonical_activity_responsible_guard.sql", sha256: "b0a2bc281f9c17e3d04f907403532138289e148eb8b7ce6c5af30ba2e35857be", dependsOn: ["202609210001_worker_activity_responsibility.sql"], requires: ["miclub.activities.responsible_employee_id"], checkpointPurpose: "Alinea la guarda de actividades activas con el trabajador responsable canónico y retira la exigencia legacy de Instructor." },
  { path: "202609220001_activity_pricing_and_schedules.sql", sha256: "9e1a81f0630500f116fda1408dd131e0596136274066cc7cc96b8a410fbacc66", dependsOn: ["202609210002_canonical_activity_responsible_guard.sql"], provides: ["miclub.table.activity_price_terms", "miclub.activity_schedules.club_id"], checkpointPurpose: "Versiona precios al alumno, protege horarios por tenant y captura precios en inscripciones." },
  { path: "202609220002_cancel_future_activity_prices.sql", sha256: "54f0feba7d5cc6e4280c1636a68906f5f43a891b1fa040ed83c1ea252b91f1d2", dependsOn: ["202609220001_activity_pricing_and_schedules.sql"], requires: ["miclub.table.activity_price_terms"], checkpointPurpose: "Conserva para auditoría las vigencias futuras canceladas y excluye su solapamiento operativo." },
  { path: "202609250001_bidirectional_movement_categories.sql", sha256: "b16fe616acdb795ab6535e3e41c4c73041a28b69049903ac6ac908ad1555a44c", dependsOn: ["202609220002_cancel_future_activity_prices.sql"], requires: ["miclub.table.category_catalog"], checkpointPurpose: "Permite ingresos y egresos con cualquier categoría activa sin cambiar identificadores ni movimientos históricos." },
];
