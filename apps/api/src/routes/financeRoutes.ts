...
router.get("/movements", requirePermission("finance:read"), asyncHandler(async (req, res) => {
...
router.get("/receivables", requirePermission("finance:read"), asyncHandler(async (req, res) => {
...
router.get("/payments", requirePermission("finance:read"), asyncHandler(async (req, res) => {
...
router.get("/operational-balances", requirePermission("finance:read"), asyncHandler(async (req, res) => res.json(await getOperationalBalances(req.auth!))));
router.get("/sector-settlements", requirePermission("finance:read"), asyncHandler(async (req, res) => res.json(await getSectorSettlements(req.auth!))));
