...
test("la política contractual sólo aprueba omitir Migración",()=>{assert.deepEqual([...OPTIONAL_ONBOARDING_STEPS],[6]);assert.deepEqual([...REQUIRED_ONBOARDING_STEPS],[1,2,3,4,5,7]);});
