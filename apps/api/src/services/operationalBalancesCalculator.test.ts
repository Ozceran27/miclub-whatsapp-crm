...
test("Saldos a Liquidar trata sector faltante como cero y normaliza signos almacenados", () => {
  assert.deepEqual(calculateSettlementBalance([{ sector: "FITNESS", amount: -40 }]), { total: -40, local1: 0, fitness: 40, salon: 0, aula: 0 });
});
...
test("Saldo Proyectado suma liquidez, cuotas, saldos a liquidar negativo y pendientes sin doble resta", () => {
