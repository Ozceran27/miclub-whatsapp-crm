...
test('separa saldos a liquidar, a cobrar y remuneración fija por moneda', () => {
  const totals = calculateBalanceTotals([
    { currencyCode: 'ARS', balance: 40_000, reviewState: 'APPROVED' },
    { currencyCode: 'ARS', balance: -25_000, reviewState: 'APPROVED' },
    { currencyCode: 'USD', balance: 100, reviewState: 'DRAFT' },
  ], [
    { currencyCode: 'ARS', balance: 12_000, reviewState: 'APPROVED' },
    { currencyCode: 'ARS', balance: 9_000, reviewState: 'DRAFT' },
  ]);
  assert.deepEqual(totals, [
    { currencyCode: 'ARS', activityToPay: 40_000, activityToCollect: 25_000, fixedCompensationToPay: 12_000, totalToPay: 52_000, approvedToPay: 52_000, pendingReviewToPay: 9_000 },
    { currencyCode: 'USD', activityToPay: 100, activityToCollect: 0, fixedCompensationToPay: 0, totalToPay: 100, approvedToPay: 0, pendingReviewToPay: 100 },
  ]);
});
