...
const input=(clubId="club-a"):WorkbookInput=>({
  ...
  resolvedRows:[{sheet:"ADMINISTRACIÓN",rowNumber:2,sectorId:"sector",activityId:null,instructorId:null,categoryId:"category",paymentMethodId:null,personId:null,accountId:"account",currencyCode:"ARS",externalReference:null,rowFingerprint:"a".repeat(64)}],
