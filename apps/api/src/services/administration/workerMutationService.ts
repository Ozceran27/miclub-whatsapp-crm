...
export const validateWorkerMutation = (body: unknown, requirePassword: boolean): AdministrationWorkerMutationDto => {
  ...
  return { ...raw, firstName, lastName, dni, email, phone: cleanText(raw.phone) || null, role: raw.role, hasFixedCompensation: raw.hasFixedCompensation, fixedCompensationAmount: amount, fixedCompensationFrequency: frequency, currencyCode } as AdministrationWorkerMutationDto;
};
