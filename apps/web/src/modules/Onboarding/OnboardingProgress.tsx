...
export function OnboardingProgress({ step, optional }: { step: OnboardingStep; optional: boolean }) {
  ...
  return <nav className="onboarding-progress" aria-label={`Progreso de configuración: paso ${step} de 7`}>
    <div className="onboarding-progress__summary"><span>Paso {step} de 7</span><span className="onboarding-requirement">{optional ? 'Opcional' : 'Obligatorio'}</span></div>
