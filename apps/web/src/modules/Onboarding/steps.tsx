...
export const getOnboardingSteps = (_migrationAvailable:boolean,draft:OnboardingDraft,update:<K extends keyof OnboardingDraft>(key:K,value:OnboardingDraft[K])=>void) => [
 ...
 {eyebrow:'Tu equipo',icon:'♙',title:'Sumá a tus trabajadores',description:'Prepará las altas que se crearán al finalizar.',body:<WorkerDraftList items={draft.workers} currency={draft.openingBalances.currency} onChange={v=>update('workers',v)}/>},
