...
export const ONBOARDING_STEPS = [
  ...
  { title: 'Conocé tu espacio', body: <><p>Desde miClub vas a centralizar la administración, la economía y la relación con tus socios.</p><ul><li>Información separada y segura para tu club.</li><li>Indicadores operativos siempre disponibles.</li><li>Configuración que podés ajustar luego.</li></ul><aside className="onboarding-warning" role="note"><strong>Migración de datos</strong><p>La importación XLSX se muestra únicamente cuando fue habilitada para tu club y tu perfil cuenta con el permiso correspondiente. Si no aparece en el menú, consultá con la administración de miClub.</p></aside><aside className="onboarding-warning" role="note"><strong>Saldos iniciales y capital histórico</strong><p>Los importes de caja, banco y dólares representan capital acumulado anterior a miClub, no ingresos del período. El lote quedará identificado para su futura conciliación desde Economía.</p><a href="/app/economia?conciliacion=apertura">Ver futura conciliación del lote importado</a></aside></> },
