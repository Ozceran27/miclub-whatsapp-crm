...
const getMetricRowClassName = (highlight) => {
    if (highlight === 'featuredGreen')
        return 'finance-metric-row finance-metric-row--featured finance-metric-row--featured-green';
    if (highlight === 'featuredRed')
        return 'finance-metric-row finance-metric-row--featured finance-metric-row--featured-red';
    if (highlight === 'featured')
        return 'finance-metric-row finance-metric-row--featured';
    if (highlight === 'green')
