...
| `202608310002_sector_capacity_modes.sql` | Normaliza modos de capacidad y centraliza récord, utilización y ociosidad por sector y tenant. | `36df6e7923df8087cdaed56fe3dd680402a41af5be0baea282c393bbcfd120bd` | Después de `202608210004_sector_templates_and_lifecycle.sql` y `202608310001_exchange_rates.sql`. |
