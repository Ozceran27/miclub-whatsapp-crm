...
La referencia vigente es [`../checkpoint-pre-admin.md`](../checkpoint-pre-admin.md). PostgreSQL, autenticación y tenant de sesión son obligatorios en producción; no se permite fallback productivo.
