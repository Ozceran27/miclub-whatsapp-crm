...
En **Sectores**, seleccionar una fila para consultar responsable, capacidad, actividades y movimientos relacionados. Administración y Tesorería permanecen en la barra principal; Áreas Comunes y los sectores personalizados aparecen en el menú **Sectores**. Los sectores de sistema están protegidos. Las acciones rápidas habilitadas permiten crear sectores personalizados, trabajadores y actividades con formularios coherentes con el Onboarding. Sectores configura nombre, icono, color, capacidad y estado sin plantillas; Trabajadores valida fotos JPG/PNG/WebP de hasta 5 MB y conserva acceso, rol, sector, fechas, notas y remuneración; Actividades acepta como responsable operativo a cualquier trabajador activo y permite que el receptor económico lo siga automáticamente o sea otra persona del equipo. La modalidad VARIABLE conserva el porcentaje del club y la modalidad FIXED conserva monto, moneda, frecuencia y vigencia histórica.
