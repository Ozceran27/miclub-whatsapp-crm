-- Script manual para DBeaver.
-- Si DBeaver dejó la sesión en una transacción abortada por un error anterior,
-- ejecutá primero este rollback y luego corré el resto del script completo.
rollback;
