export type SectorIconCategory = "deportes" | "comercio" | "servicios" | "instalaciones" | "administracion" | "tesoreria" | "social" | "salud" | "mantenimiento" | "marketing" | "gastronomia";
...
export const SECTOR_ICON_CATALOG: readonly SectorIconCatalogItem[] = [
  ...
  {key:"american-football",name:"Fútbol americano",category:"deportes",glyph:"🏈"},{key:"rugby",name:"Rugby",category:"deportes",glyph:"🏉"},{key:"baseball",name:"Béisbol",category:"deportes",glyph:"⚾"},{key:"table-tennis",name:"Tenis de mesa",category:"deportes",glyph:"🏓"},{key:"badminton",name:"Bádminton",category:"deportes",glyph:"🏸"},{key:"martial-arts",name:"Artes marciales",category:"deportes",glyph:"🥋"},{key:"cycling",name:"Ciclismo",category:"deportes",glyph:"🚴"},{key:"golf",name:"Golf",category:"deportes",glyph:"⛳"},
  ...
  {key:"legal",name:"Asuntos legales",category:"administracion",glyph:"⚖️"},{key:"education",name:"Capacitación",category:"servicios",glyph:"🎓"},{key:"it-support",name:"Soporte técnico",category:"servicios",glyph:"💻"},
  ...
  {key:"pharmacy",name:"Farmacia",category:"salud",glyph:"💊"},{key:"ambulance",name:"Ambulancia",category:"salud",glyph:"🚑"},
  ...
  {key:"bakery",name:"Panadería",category:"gastronomia",glyph:"🥐"},{key:"catering",name:"Catering",category:"gastronomia",glyph:"🍲"},{key:"ice-cream",name:"Heladería",category:"gastronomia",glyph:"🍦"},
  {key:"store",name:"Tienda",category:"comercio",glyph:"🏪"},{key:"shopping",name:"Compras",category:"comercio",glyph:"🛍️"},{key:"ticket-office",name:"Boletería",category:"comercio",glyph:"🎟️"},
  {key:"clubhouse",name:"Sede social",category:"instalaciones",glyph:"🏠"},{key:"locker-room",name:"Vestuarios",category:"instalaciones",glyph:"🚪"},{key:"showers",name:"Duchas",category:"instalaciones",glyph:"🚿"},{key:"pool",name:"Piscina",category:"instalaciones",glyph:"🏊‍♂️"},{key:"courts",name:"Canchas",category:"instalaciones",glyph:"🎯"},
